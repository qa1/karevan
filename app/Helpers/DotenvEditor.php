...
class DotenvEditor
{
    ...
    {
        $backupPath = storage_path('app/dotenvbackup');
        $env        = base_path('.env');
    ...
    public function getValue($key)
    {
        if ($this->keyExists($key)) {
            ...
            throw new \Exception(trans('dotenv-editor::class.requested_value_not_available'), 0);
        }
    }
    /**
    ...
    public function setAutoBackup($onOff)
    {
        if (is_bool($onOff)) {
            ...
            throw new \Exception(trans('dotenv-editor::class.autobackup_wrong_value'), 0);
        }
    }
    /**
    ...
    protected function getFile($timestamp)
    {
        ...
        if (file_exists($file)) {
            ...
            throw new \Exception(trans('dotenv-editor::class.requested_backup_not_found'), 0);
        }
    }
    /**
    ...
    public function getBackupVersions()
    {
        ...
        throw new \Exception(trans('dotenv-editor::class.no_backups_available'), 0);
    }
    /**
    ...
    public function deleteBackup($timestamp)
    {
        ...
        if (file_exists($file)) {
            ...
            throw new \Exception(trans('dotenv-editor::class.backup_not_deletable'), 0);
        }
    }
    ...
    public function changeEnv($data = array())
    {
        ...
        throw new \Exception(trans('dotenv-editor::class.array_needed'), 0);
    }
    /**
    ...
    public function deleteData($data = array())
    {
        foreach ($data as $key => $value) {
            if (!is_numeric($key)) {
                throw new \Exception("dotenv-editor::class.numeric_array_needed", 0);
            }
        }
        if ($this->AutoBackupEnabled()) {
            $this->createBackup();
