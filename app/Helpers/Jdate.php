...
class Jdate
{
     ...
     * e.g $obj = new jDate(false, true, 'Asia/Tehran');
     ...
     */
    public function __construct($convert = false, $jalali = null, $timezone = 'Asia/Tehran')
    {
     ...
     *  $date = \jDate::convertFormatToFormat('Y-m-d H:i:s', 'Y-m-d H:i:s', $a);
